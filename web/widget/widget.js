...
(() => {
  ...
  style.textContent = `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, "PingFang SC", "Microsoft YaHei", sans-serif; }
    ...
    .head .minimize svg { width: 18px; height: 18px; display: block; }
  ...
  wrap.innerHTML = `
    <div class="panel" part="panel">
      ...
      <div class="head"><img class="avatar" alt=""><span class="t"></span><div class="ctrls"><button class="maximize" type="button" aria-label="全屏显示" aria-pressed="false" title="全屏显示"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M8 3H5a2 2 0 0 0-2 2v3M16 3h3a2 2 0 0 1 2 2v3M8 21H5a2 2 0 0 1-2-2v-3M16 21h3a2 2 0 0 0 2-2v-3"/></svg></button><button class="restart" type="button" aria-label="开启新对话" title="开启新对话"><svg viewBox="0 0 1024 1024" fill="currentColor" aria-hidden="true"><path d="M788.266667 625.749333A298.666667 298.666667 0 1 1 721.024 298.666667H640a42.666667 42.666667 0 0 0 0 85.333333h170.666667a42.666667 42.666667 0 0 0 42.666666-42.666667V170.666667a42.666667 42.666667 0 0 0-85.333333 0v55.125333A384 384 0 0 0 128 512a384 384 0 0 0 739.2 146.133333 42.666667 42.666667 0 0 0-78.890667-32.341333l-0.042666-0.042667z"/></svg></button><button class="minimize" type="button" aria-label="最小化" title="最小化"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="M5 12h14"/></svg></button></div></div>
      <div class="msgs"></div>
  ...
  wrap.querySelector('.minimize').addEventListener('click', () => panel.classList.remove('open'));
