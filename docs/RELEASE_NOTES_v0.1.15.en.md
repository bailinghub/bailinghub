# BailingHub v0.1.15: Trusted Rich Rendering and Chat Reliability

`v0.1.15` improves perceived latency, structured presentation, and runtime convergence for business-facing chat. The official widget remains dependency-free. Charts and other rich content are registered explicitly by the host as trusted renderers, while model output remains constrained declarative data.
...
- [中文发布说明](RELEASE_NOTES_v0.1.15.md)
