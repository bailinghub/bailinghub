...
| [WIDGET_RENDERERS.en.md](WIDGET_RENDERERS.en.md) | Trusted rich-content renderer extension for charts and interactive reports in the chat widget. |
| [WIDGET_RENDERERS.md](WIDGET_RENDERERS.md) | Chinese trusted widget renderer guide. |
...
| [RELEASE_NOTES_v0.1.7.en.md](RELEASE_NOTES_v0.1.7.en.md) | `v0.1.7` versioned Client API and cross-ecosystem compatibility-gate release notes. |
| [RELEASE_NOTES_v0.1.7.md](RELEASE_NOTES_v0.1.7.md) | Chinese `v0.1.7` release notes. |
| [RELEASE_NOTES_v0.1.8.en.md](RELEASE_NOTES_v0.1.8.en.md) | `v0.1.8` create-once initial-admin bootstrap release notes. |
...
| [RELEASE_NOTES_v0.1.11.en.md](RELEASE_NOTES_v0.1.11.en.md) | `v0.1.11` side-effect execution journal and uncertain-outcome freezing release notes. |
